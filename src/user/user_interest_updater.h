...
public:
    ...
    // 更新兴趣模型（主函数）
    // 根据用户的点击历史、浏览历史、点赞历史等，更新 category_interests
...
private:
    ...
    float click_weight_ = 0.5f;     // 点击权重
    float view_weight_ = 0.2f;      // 浏览权重
    float like_weight_ = 0.8f;      // 点赞权重
